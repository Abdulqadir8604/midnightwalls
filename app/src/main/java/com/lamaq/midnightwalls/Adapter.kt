...
class Adapter     // Constructor for initialization
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val glideUrl = GlideUrl(image[position] as String, LazyHeaders.Builder()
            .addHeader("User-Agent", "your-user-agent")
            .build())
        Glide.with(context).load(glideUrl).placeholder(R.drawable.image_placeholder).into(holder.images)
